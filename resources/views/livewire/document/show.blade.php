    ...
    <div class="d-flex justify-content-between align-items-center">
        <div>
            ...
            <div class="d-flex gap-2 align-items-center mt-1">
                ...
                <span class="text-muted text-sm">&middot; Prefix: {{ $document->prefix }}</span>
                @if($document->linkedDocument)
                    <span class="text-muted text-sm">&middot; Verknuepft mit:
                        <a href="{{ route('specs.documents.show', $document->linkedDocument) }}">{{ $document->linkedDocument->name }}</a>
                    </span>
                @endif
            </div>
        </div>
